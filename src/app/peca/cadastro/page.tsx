...
export default function CadastroPeca() {
  ...
  return (
    <main className="min-h-screen bg-gray-300">
      <div className="text-2xl text-gray-600 px-10 pt-10">CORTE DE PEÇAS</div>
      ...
      <form action="">
        ...
        {inputList.map((input, index) => (
          <div className="flex flex-row gap-96 pb-10">
            <div className="pl-10 min-w-10 lg:min-w-80">
              <label htmlFor="cor" id="cor" className="text-xs text-gray-500">
                Cor
              </label>
              <select
                className="bg-transparent w-full py-1.5 text-gray-800 border-b border-gray-500
            ...
            <div className="text-xl uppercase text-gray-500 flex flex-row justify-center gap-10">
              ...
              <div className="flex flex-col">
                <label htmlFor="xgg">{gridIsAdult ? "xgg" : "10"}</label>
