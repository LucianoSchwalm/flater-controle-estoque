      ...
      <main className="bg-gray-300 min-h-screen">
         <div className="justify-items-left py-5 min-h-screen">
            <div className="p-8">
               ...
               ></div>
               <div className="text-2xl text-black text-left pb-10 w-full mx-auto flex justify-center">
                  Insira o Tecido que Deseja Retirar do Estoque
               </div>
               <form>
                  <div className="min-h-72">
                     <div className="grid grid-cols-4 gap-10">
                        <div className="col-start-2 col-end-4 pb-10">
                           <label
                              htmlFor="tecido"
                  ...
                  <div className="w-full mx-auto flex justify-center">
                     <input
                        className="shadow-lg mt-3 pt-3 pb-3 w-1/4 text-white bg-red-500
                  hover:bg-red-400 rounded-full cursor-pointer"
                        type="submit"
                        value="Clique para Remover"
                     />
                  </div>
               </form>
            </div>
